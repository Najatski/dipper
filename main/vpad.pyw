...
class Riffmaster:
    ...
    def main_loop():
        ...
        while Riffmaster.running:
            ...
            Riffmaster.update_controller_features(inputs[44], inputs[45], inputs[1], inputs[2])
...
class GUI:
    ...
    release_label = ctk.CTkLabel(caption_frame,text='v1.0.0',font=('Consolas',30))
    ...
    checkbox_3 = ctk.CTkCheckBox(options_frame,text='—————— TBD ——————',font=('Consolas',18),state='disabled')
    checkbox_3.pack(pady=7,padx=25,anchor=ctk.W)
    ...
    news_info = ctk.CTkLabel(news_box, font=('Consolas',20), text='- New GUI\n- Removed vJoy\n- v1.0.0 release!')
    news_info.pack(side=ctk.LEFT,anchor=ctk.NW)
